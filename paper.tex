...
% calculation basics
To demonstrate the practical use of this theoretical framework, we present an example bulk computation for both hBN and the 4H polytype of silicon carbide (SiC), as is shown in Figure 1(a). 
...
\begin{figure}[t]
\includegraphics[width=8cm]{sic-structure.pdf}
